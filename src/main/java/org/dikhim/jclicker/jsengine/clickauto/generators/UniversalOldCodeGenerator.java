...
public abstract class UniversalOldCodeGenerator implements OldCodeGenerator {
    ...
    UniversalOldCodeGenerator(String objectName, int lineSize, Class c) {
    ...
    UniversalOldCodeGenerator(String objectName, Class c) {
        this.objectName = objectName;
        methods.addAll(Arrays.asList(c.getDeclaredMethods()));
        for(Class<?> inf: c.getInterfaces()){
            methods.addAll(Arrays.asList(inf.getDeclaredMethods()));
     ...
     */
    protected UniversalOldCodeGenerator append(String str) {
     ...
     * @return a reference to this object
     */
    protected UniversalOldCodeGenerator append(int i) {
        sb.append(i);
        return this;
    }
     ...
     * @return a reference to this object
     */
    protected UniversalOldCodeGenerator append(float f) {
        sb.append(f);
        return this;
    }
    /**
     ...
     * @return a reference to this object
     */
    protected UniversalOldCodeGenerator append(double f) {
        sb.append(f);
        return this;
    }
